...
angular.module("app.subject",["ng"])
    .controller("subjectDelController",["$scope","$routeParams","subjectService","$location",
        function ($scope,$routeParams,subjectService,$location) {
    ...
    .controller("subjectCheController",["$routeParams","subjectService","$location", function ($routeParams,subjectService,$location) {
    ...
    .service("subjectService",["$http","$httpParamSerializer",function ($http,$httpParamSerializer) {
        ...
        this.getAllSubjects = function (params,handler) {
            ...
            //console.log(data);
            $http.get("http://172.16.0.5:7777/test/exam/manager/getAllSubjects.action",{params:data})
            //$http.get("data/subjects.json",{data:data})
                .success(function (data) {
                handler(data);
            });
        };
